"""
Icon-Challenge Configuration
40 Icons Pool + Context Settings
"""

# 40 Icons Pool (SVG-Definitionen)
ICON_POOL = {
...
CHALLENGE_CONTEXTS = {
    'guest': {
        'title': '🔐 Gast-Zugang',
        'description': 'Terminal Identitäts-Check',
        'grid_size': 9,  # 3×3
        'min_count': 2,
        'max_count': 4,
        'cooldown_3': 30,
    ...
    'contact': {
        ...
        'description': 'Sicherheits-Prüfung',
        'grid_size': 9,  # 3×3
        'min_count': 2,
        'max_count': 4,
        'cooldown_3': 30,
    ...
    'signup': {
        ...
        'description': 'Account-Sicherheit',
        'grid_size': 9,  # 3×3
        'min_count': 2,
        'max_count': 4,
        'cooldown_3': 60,  # Strenger!
        'cooldown_5': 120,
    },
}